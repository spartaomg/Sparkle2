...
//	Version history
//
//	v1.2	- separate checksum verification loop in drive code
//
//	v1.3	- checksum verification integrated in transfer loop in drive code
//
//	v1.4	- new, tighter receive loop, tabs eliminated
//
//	v1.5	- loads all 3 drive code blocks in one command
...
//
//	v1.8	- new 126-cycle GCR decoding loop (Sparkle 1)
//
//	v1.9	- drive reset detection
//
//	v2.0	- tighter drive transfer loop
//
//	v2.1	- 4 blocks loaded with code in command buffer
//
//	v2.2	- improved, 125-cycle GCR decoding loop (Sparkle 1)
//
//	v2.3	- new code in command buffer, loads 5 blocks in one command
//
//	v2.4	- introducing Spartan Stepping
//	
//	v2.5	- new LZ compression/decompression
...
//
//	v2.6	- most compact and feature-packed version (5 bytes left free!!!)
...
//		  Fallback IRQ:		    $02e2
//
//	v2.7	- back-to-back LZ compression: no half-blocks left unused
...
MidLitSeq:	ldy	#$f8
		bpl	SkipML		//C=1 here
		lda	Buffer,x	//6 cycles and 5 bytes less here
		tay
		dex
		lsr			//0xxxx...
		lsr			//00xxxx..
		alr	#$3c		//000xxxx0	C=0, N=0 after this -> 
SkipML:		arr	#$1e		//0000xxxx vs 1000xxxx	C=0, N=0 vs N=1 here depending on the branch taken
...
///*
		...
		inc	$d019
//*/
//		dec	$00		//This will make sure that $01 reads #$35 whether its acutal value is #$34 or #$35
					//Saves 6 bytes, but causes problems with stacked IRQs
Sparkle_IRQ_JSR:
